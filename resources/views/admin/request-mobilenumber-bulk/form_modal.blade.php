<div class="modal fade" id="uploadformModal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            ...
            <form id="dataForm" class="" method="POST" enctype="multipart/form-data" action="{{ route('request-mobilenumber-bulk.store') }}">
             @csrf
            <div class="modal-body m-3">
               ...
               <div class="row">
                 <div class="form-group">
                   <a href="{{asset('assets/samplefiles/request_mobile_number.csv')}}" target="_blank"><small><i class="fas fa-file"></i> Download the sample file here</small></a></label>
                 </div>
               </div>
