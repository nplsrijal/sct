					...
					<div class="d-flex justify-content-center">
						...
						<div class="flex-grow-1 ps-2">
							...
							<div class="dropdown-menu dropdown-menu-start">
								<a class="dropdown-item" href="pages-profile.html"><i class="align-middle me-1" data-feather="key"></i> Change Password</a>
								<div class="dropdown-divider"></div>
								
								<a class="dropdown-item" href="{{url('/admin/logout')}}">Log out</a>
							</div>

							<div class="sidebar-user-subtitle">{{$userinfo->typename}}</div>
						</div>
					</div>
				</div>
					...
					<ul class="navbar-nav navbar-align">
						...
						<li class="nav-item dropdown">
							<a class="nav-icon pe-md-0 dropdown-toggle" href="#" data-bs-toggle="dropdown">
								Hi,{{$userinfo->fname.' '.$userinfo->lname}} !
							</a>
